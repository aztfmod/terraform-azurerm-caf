...
locals {
  ...
  shared_services = {
    ...
    monitor_dashboard_grafana                        = try(var.shared_services.monitor_dashboard_grafana, {})
    monitor_dashboard_grafana_workspace_integrations = try(var.shared_services.monitor_dashboard_grafana_workspace_integrations, {})
