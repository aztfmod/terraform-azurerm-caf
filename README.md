...
| <a name="input_dynamic_keyvault_secrets"></a> [dynamic\_keyvault\_secrets](#input\_dynamic\_keyvault\_secrets) | n/a | `any` | `{}` | no |
| <a name="input_enable"></a> [enable](#input\_enable) | Map of services defined in the configuration file you want to disable during a deployment. | `any` | `{}` | no |
| <a name="input_environment"></a> [environment](#input\_environment) | Name of the CAF environment. | `string` | `"sandpit"` | no |
| <a name="input_event_hub_auth_rules"></a> [event\_hub\_auth\_rules](#input\_event\_hub\_auth\_rules) | Configuration object - Event Hub authentication rules | `any` | `{}` | no |
| <a name="input_event_hub_consumer_groups"></a> [event\_hub\_consumer\_groups](#input\_event\_hub\_consumer\_groups) | Configuration object - Event Hub consumer group rules | `any` | `{}` | no |
| <a name="input_event_hub_namespace_auth_rules"></a> [event\_hub\_namespace\_auth\_rules](#input\_event\_hub\_namespace\_auth\_rules) | Configuration object - Event Hub namespaces authentication rules | `any` | `{}` | no |
| <a name="input_event_hub_namespaces"></a> [event\_hub\_namespaces](#input\_event\_hub\_namespaces) | Configuration object - Diagnostics object. | `any` | `{}` | no |
| <a name="input_event_hubs"></a> [event\_hubs](#input\_event\_hubs) | Configuration object - Event Hub resources | `any` | `{}` | no |
| <a name="input_global_settings"></a> [global\_settings](#input\_global\_settings) | Global settings object for the current deployment. | `any` | <pre>{<br>  "default_region": "region1",<br>  "passthrough": false,<br>  "random_length": 4,<br>  "regions": {<br>    "region1": "southeastasia",<br>    "region2": "eastasia"<br>  }<br>}</pre> | no |
| <a name="input_identity"></a> [identity](#input\_identity) | Configuration object - identity resources | `any` | `{}` | no |
| <a name="input_iot"></a> [iot](#input\_iot) | Configuration object - IoT | `any` | `{}` | no |
| <a name="input_keyvault_access_policies"></a> [keyvault\_access\_policies](#input\_keyvault\_access\_policies) | Configuration object - Azure Key Vault policies | `any` | `{}` | no |
| <a name="input_keyvault_access_policies_azuread_apps"></a> [keyvault\_access\_policies\_azuread\_apps](#input\_keyvault\_access\_policies\_azuread\_apps) | Configuration object - Azure Key Vault policy for azure ad applications | `any` | `{}` | no |
| <a name="input_keyvault_certificate_issuers"></a> [keyvault\_certificate\_issuers](#input\_keyvault\_certificate\_issuers) | Configuration object - Azure Key Vault Certificate Issuers resources | `any` | `{}` | no |
| <a name="input_keyvaults"></a> [keyvaults](#input\_keyvaults) | Configuration object - Azure Key Vault resources | `any` | `{}` | no |
| <a name="input_log_analytics"></a> [log\_analytics](#input\_log\_analytics) | Configuration object - Log Analytics resources. | `any` | `{}` | no |
...
| <a name="input_logic_app"></a> [logic\_app](#input\_logic\_app) | Configuration object - Azure Logic App resources | `any` | `{}` | no |
...
| <a name="input_resource_groups"></a> [resource\_groups](#input\_resource\_groups) | Configuration object - Resource groups. | `any` | `{}` | no |
| <a name="input_resource_provider_registration"></a> [resource\_provider\_registration](#input\_resource\_provider\_registration) | n/a | `any` | `{}` | no |
| <a name="input_role_mapping"></a> [role\_mapping](#input\_role\_mapping) | Configuration object - Role mapping | `any` | <pre>{<br>  "built_in_role_mapping": {},<br>  "custom_role_mapping": {}<br>}</pre> | no |
| <a name="input_security"></a> [security](#input\_security) | Configuration object - security resources | `any` | `{}` | no |
| <a name="input_sentinel_watchlists"></a> [sentinel\_watchlists](#input\_sentinel\_watchlists) | n/a | `any` | `{}` | no |
| <a name="input_shared_services"></a> [shared\_services](#input\_shared\_services) | Configuration object - Shared services resources | `any` | `{}` | no |
| <a name="input_storage"></a> [storage](#input\_storage) | Configuration object - Storage account resources | `any` | `{}` | no |
| <a name="input_storage_accounts"></a> [storage\_accounts](#input\_storage\_accounts) | Configuration object - Storage account resources | `any` | `{}` | no |
| <a name="input_subscription_billing_role_assignments"></a> [subscription\_billing\_role\_assignments](#input\_subscription\_billing\_role\_assignments) | Configuration object - subscription billing roleassignments. | `any` | `{}` | no |
| <a name="input_subscriptions"></a> [subscriptions](#input\_subscriptions) | Configuration object - Subscriptions resources. | `any` | `{}` | no |
...
| <a name="input_tfstates"></a> [tfstates](#input\_tfstates) | Terraform states configuration object. Used in the context of landing zone deployment. | `any` | `{}` | no |
| <a name="input_use_msi"></a> [use\_msi](#input\_use\_msi) | Deployment using an MSI for authentication. | `bool` | `false` | no |
| <a name="input_user_type"></a> [user\_type](#input\_user\_type) | The rover set this value to user or serviceprincipal. It is used to handle Azure AD API consents. | `any` | `{}` | no |
| <a name="input_var_folder_path"></a> [var\_folder\_path](#input\_var\_folder\_path) | n/a | `string` | `""` | no |
| <a name="input_webapp"></a> [webapp](#input\_webapp) | Configuration object - Web Applications | `any` | `{}` | no |
