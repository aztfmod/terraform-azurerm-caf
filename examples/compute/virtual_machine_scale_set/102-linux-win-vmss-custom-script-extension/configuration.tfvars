...
storage_account_blobs = {
  script1 = {
    ...
    source                 = "example/compute/virtual_machine_scale_set/102-linux-win-vmss-custom-script-extension/scripts/helloworld.sh"
    parallelism            = 1
  }
  script2 = {
    name                   = "helloworld.ps1"
    storage_account_key    = "sa1"
    storage_container_name = "files"
    source                 = "example/compute/virtual_machine_scale_set/102-linux-win-vmss-custom-script-extension/scripts/helloworld.ps1"
    parallelism            = 1
  }
}
