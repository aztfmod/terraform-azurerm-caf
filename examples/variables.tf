...
variable "synapse_integration_runtime_azure" {
  default = {}
}

variable "synapse_integration_runtime_self_hosted" {
  default = {}
}

variable "synapse_linked_service" {
  default = {}
}
...
variable "synapse_role_assignment" {
  default = {}
}
...
variable "synapse_sql_pool_extended_auditing_policy" {
  default = {}
}
variable "synapse_sql_pool_security_alert_policy" {
  default = {}
}
variable "synapse_sql_pool_vulnerability_assessment" {
  default = {}
}
variable "synapse_sql_pool_vulnerability_assessment_baseline" {
  default = {}
}
variable "synapse_sql_pool_workload_classifier" {
  default = {}
}
variable "synapse_sql_pool_workload_group" {
  default = {}
}
variable "synapse_workspace" {
  default = {}
}
variable "synapse_workspace_aad_admin" {
  default = {}
}
variable "synapse_workspace_extended_auditing_policy" {
  default = {}
}
variable "synapse_workspace_keys" {
  default = {}
}
variable "synapse_workspace_security_alert_policy" {
  default = {}
}
variable "synapse_workspace_sql_aad_admin" {
  default = {}
}
variable "synapse_workspace_vulnerability_assessment" {
  default = {}
}
