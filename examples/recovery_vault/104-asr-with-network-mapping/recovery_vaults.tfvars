  ...
  asr1 = {
    ...
    protection_container_mapping = {
      hk-sg = {
        ...
        vault_key                       = "asr1"
        resource_group_key              = "sharedservices-asr"
        fabric_key                      = "fabric1"
    ...
    network_mappings = {
      map1 = {
        ...
        #source_network_id = "/subscriptions/********/resourceGroups//********/providers/Microsoft.Network/virtualNetworks/vnet-********-sandbox-asr"
        # Use the vnet id to use a network created outside of CAF
        target_network_id = {
          #lz_key   = ""
          vnet_key = "vnet_region1"
        }
        #target_network_id = "/subscriptions/********/resourceGroups/********/providers/Microsoft.Network/virtualNetworks/vnet-********-sandbox-asr"
        # Use the vnet id to use a network created outside of CAF
      }
