...
module "mssql_managed_instances" {
  ...
  primary_server_id   = try(each.value.primary_server.key, null) == null ? "" : var.remote_objects.mssql_managed_instances[each.value.primary_server.lz_key][each.value.primary_server.key].id
