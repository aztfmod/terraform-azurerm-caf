locals {
  ...
  combined_objects_storage_data_lake_gen2_filesystem              = merge(tomap({ (local.client_config.landingzone_key) = module.storage_data_lake_gen2_filesystem }), try(var.remote_objects.storage_data_lake_gen2_filesystem, {}))
  ...
  combined_objects_synapse_workspace                              = merge(tomap({ (local.client_config.landingzone_key) = module.synapse_workspace }), try(var.remote_objects.synapse_workspace, {}))
  combined_objects_synapse_spark_pool                             = merge(tomap({ (local.client_config.landingzone_key) = module.synapse_spark_pool }), try(var.remote_objects.synapse_spark_pool, {}))
  combined_objects_synapse_sql_pool                               = merge(tomap({ (local.client_config.landingzone_key) = module.synapse_sql_pool }), try(var.remote_objects.synapse_sql_pool, {}))
  combined_objects_synapse_sql_pool_workload_group                = merge(tomap({ (local.client_config.landingzone_key) = module.synapse_sql_pool_workload_group }), try(var.remote_objects.synapse_sql_pool_workload_group, {}))
  combined_objects_synapse_sql_pool_vulnerability_assessment      = merge(tomap({ (local.client_config.landingzone_key) = module.synapse_sql_pool_vulnerability_assessment }), try(var.remote_objects.synapse_sql_pool_vulnerability_assessment, {}))
  combined_objects_synapse_workspace_security_alert_policy        = merge(tomap({ (local.client_config.landingzone_key) = module.synapse_workspace_security_alert_policy }), try(var.remote_objects.synapse_workspace_security_alert_policy, {}))
  combined_objects_synapse_sql_pool_security_alert_policy         = merge(tomap({ (local.client_config.landingzone_key) = module.synapse_sql_pool_security_alert_policy }), try(var.remote_objects.synapse_sql_pool_security_alert_policy, {}))
