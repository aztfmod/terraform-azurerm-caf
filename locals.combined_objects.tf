locals {
  ...
  combined_objects_azuread_applications_v1           = merge(tomap({ (local.client_config.landingzone_key) = module.azuread_applications_v1 }), try(var.remote_objects.azuread_applications_v1, {}))
