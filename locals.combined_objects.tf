locals {
  ...
  combined_objects_eventgrid_domains                              = merge(tomap({ (local.client_config.landingzone_key) = module.eventgrid_domains }), try(var.remote_objects.eventgrid_domains, {}))
  combined_objects_eventgrid_domain_topics                        = merge(tomap({ (local.client_config.landingzone_key) = module.eventgrid_domain_topics }), try(var.remote_objects.eventgrid_domain_topics, {}))
  combined_objects_eventgrid_event_subscriptions                  = merge(tomap({ (local.client_config.landingzone_key) = module.eventgrid_event_subscriptions }), try(var.remote_objects.eventgrid_event_subscriptions, {}))
  ...
  #combined_objects_hybrid_connections                            = merge(tomap({ (local.client_config.landingzone_key) = module.hybrid_connections }), try(var.remote_objects.hybrid_connections, {}))
