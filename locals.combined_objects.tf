locals {
  ...
  combined_objects_front_door_waf_policies    = merge(map(local.client_config.landingzone_key, module.front_door_waf_policies), try(var.remote_objects.front_door_waf_policies, {}))
