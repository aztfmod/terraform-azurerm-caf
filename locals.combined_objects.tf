locals {
  ...
  combined_objects_azuread_applications                           = merge(tomap({ (local.client_config.landingzone_key) = module.azuread_graph_application }), try(var.remote_objects.azuread_applications, {}))
  combined_objects_azuread_apps                                   = merge(tomap({ (local.client_config.landingzone_key) = module.azuread_graph_application }), try(var.remote_objects.azuread_apps, {}))
  combined_objects_azuread_groups                                 = merge(tomap({ (local.client_config.landingzone_key) = module.azuread_graph_group }), try(var.remote_objects.azuread_groups, {}))
  combined_objects_azuread_service_principals                     = merge(tomap({ (local.client_config.landingzone_key) = module.azuread_graph_service_principal }), try(var.remote_objects.azuread_service_principals, {}))
  combined_objects_azuread_users                                  = merge(tomap({ (local.client_config.landingzone_key) = module.azuread_graph_user }), try(var.remote_objects.azuread_users, {}))
  combined_objects_azuread_administrative_units                   = merge(tomap({ (local.client_config.landingzone_key) = module.azuread_graph_administrative_unit }), try(var.remote_objects.administrative_unit, {}))
  combined_objects_azuread_directory_roles                        = merge(tomap({ (local.client_config.landingzone_key) = module.azuread_graph_directory_role }), try(var.remote_objects.azuread_directory_roles, {}))
