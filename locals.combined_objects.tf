locals {
  ...
  combined_objects_api_management_group                           = merge(tomap({ (local.client_config.landingzone_key) = module.api_management_group }), try(var.remote_objects.api_management_group, {}))
  combined_objects_api_management_user                            = merge(tomap({ (local.client_config.landingzone_key) = module.api_management_user }), try(var.remote_objects.api_management_user, {}))
