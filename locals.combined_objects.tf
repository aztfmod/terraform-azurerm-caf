locals {
  ...
  combined_objects_monitor_private_link_scope                     = merge(tomap({ (local.client_config.landingzone_key) = module.monitor_private_link_scope }), try(var.remote_objects.monitor_private_link_scope, {}))
