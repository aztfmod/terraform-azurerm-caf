module "machine_learning_workspaces" {
  ...
  storage_account_id      = lookup(each.value, "storage_account_key", null) == null ? null : module.storage_accounts[lookup(each.value, "storage_account_key")].id
  keyvault_id             = lookup(each.value, "keyvault_key", null) == null ? null : module.keyvaults[lookup(each.value, "keyvault_key")].id
  application_insights_id = lookup(each.value, "application_insights_key", null) == null ? null : module.azurerm_application_insights[lookup(each.value, "application_insights_key")].id
