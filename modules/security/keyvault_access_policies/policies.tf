...
module azuread_apps {
  ...
  object_id     = try(each.value.lz_key , null) == null ? var.azuread_apps[var.client_config.landingzone_key][each.value.azuread_app_key].azuread_service_principal.object_id : var.azuread_apps[each.value.lz_key][each.value.azuread_app_key].azuread_service_principal.object_id
}
