...
locals {
  ...
  servicebus_namespace_name = var.remote_objects.servicebus_namespaces[try(var.settings.servicebus_namespace.lz_key, var.client_config.landingzone_key)][var.settings.servicebus_namespace.key].name
}