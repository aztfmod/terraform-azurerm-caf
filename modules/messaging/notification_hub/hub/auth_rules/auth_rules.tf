resource "azurecaf_name" "notification_hub_auth_rule" {
...
resource "azurerm_notification_hub_authorization_rule" "notification_hub_auth_rule" {
  name                  = azurecaf_name.notification_hub_auth_rule.result
