...
resource "azurerm_api_management" "apim" {
  ...
  dynamic "security" {
    ...
    content {
      ...
      triple_des_ciphers_enabled                          = can(security.value.triple_des_ciphers_enabled) ? try(security.value.triple_des_ciphers_enabled, null) : try(security.value.enable_triple_des_ciphers, null)
