    ...
    content {
      ...
      dynamic "ingress_application_gateway" {
        ...
        content {
          ...
          subnet_id    = try(ingress_application_gateway.value.subnet_id, var.vnets[try(ingress_application_gateway.value.virtual_network_subnet.lz_key, var.client_config.landingzone_key)][ingress_application_gateway.value.vnet_key].subnets[ingress_application_gateway.value.subnet_key].id, null)
        }
      }
    }
  }
