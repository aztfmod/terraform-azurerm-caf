...
resource "azurerm_windows_virtual_machine_scale_set" "vmss" {
  ...
  source_image_id = try(each.value.source_image_reference, null) == null ? format("%s%s",
    try(each.value.custom_image_id, var.image_definitions[try(each.value.custom_image_lz_ke, var.client_config.landingzone_key)][each.value.custom_image_key].id),
