...
resource "azurerm_subscription" "sub" {
  ...
  billing_scope_id  = try(var.settings.subscription_id, null) != null ? null : try(var.settings.billing_scope_id, null) == null ?  try(data.azurerm_billing_enrollment_account_scope.sub.0.id, null) : var.settings.billing_scope_id
