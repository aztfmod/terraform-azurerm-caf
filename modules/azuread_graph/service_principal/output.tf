output "application_id" {
  value       = azuread_service_principal.serp.application_id
...
output "account_enabled" {
  value       = azuread_service_principal.serp.account_enabled
  description = "Whether or not the service principal account is enabled"
}
output "alternative_names" {
  value       = azuread_service_principal.serp.alternative_names
...
output "app_role_assignment_required" {
  value       = azuread_service_principal.serp.app_role_assignment_required
...
output "description" {
  value       = azuread_service_principal.serp.description
  description = "Description of the service principal provided for internal end-users"
}
output "feature_tags" {
  value       = azuread_service_principal.serp.feature_tags
  description = "Block of features to configure for this service principal using tags"
}
output "features" {
  value       = azuread_service_principal.serp.features
  description = "Block of features to configure for this service principal using tags"
}
output "login_url" {
  value       = azuread_service_principal.serp.login_url
...
output "notes" {
  value       = azuread_service_principal.serp.notes
...
output "notification_email_addresses" {
  value       = azuread_service_principal.serp.notification_email_addresses
...
output "owners" {
  value       = azuread_service_principal.serp.owners
...
output "preferred_single_sign_on_mode" {
  value       = azuread_service_principal.serp.preferred_single_sign_on_mode
...
output "oauth2_permission_scopes" {
  value       = azuread_service_principal.serp.oauth2_permission_scopes
  description = ""
}
output "oauth2_permission_scope_ids" {
  value       = azuread_service_principal.serp.oauth2_permission_scope_ids
...
output "redirect_uris" {
  value       = azuread_service_principal.serp.redirect_uris
