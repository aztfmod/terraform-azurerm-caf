output "user_principal_name" {
  value       = azuread_user.use.user_principal_name
  description = "The user principal name (UPN) of the user"
}
output "display_name" {
  value       = azuread_user.use.display_name
  description = "The name to display in the address book for the user"
}
output "account_enabled" {
  value       = azuread_user.use.account_enabled
  description = "Whether or not the account should be enabled"
}
output "age_group" {
  value       = azuread_user.use.age_group
  description = "The age group of the user"
}
output "business_phones" {
  value       = azuread_user.use.business_phones
...
output "city" {
  value       = azuread_user.use.city
  description = "The city in which the user is located"
}
output "company_name" {
  value       = azuread_user.use.company_name
...
output "force_password_change" {
  value       = azuread_user.use.force_password_change
...
output "disable_password_expiration" {
  value       = azuread_user.use.disable_password_expiration
  description = "Whether the users password is exempt from expiring"
}
output "postal_code" {
  value       = azuread_user.use.postal_code
...
output "about_me" {
  value       = azuread_user.use.about_me
  description = "A freeform field for the user to describe themselves"
}
output "object_id" {
  value       = azuread_user.use.object_id
  description = "The object ID of the user"
}
output "creation_type" {
  value       = azuread_user.use.creation_type
