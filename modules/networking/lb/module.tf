...
resource "azurerm_lb" "lb" {
  ...
  dynamic "frontend_ip_configuration" {
    ...
    content {
      ...
      subnet_id = try(
        var.remote_objects.virtual_network[frontend_ip_configuration.value.subnet.lz_key][frontend_ip_configuration.value.subnet.vnet_key][frontend_ip_configuration.value.subnet.key].id, var.remote_objects.virtual_network[var.client_config.landingzone_key][frontend_ip_configuration.value.subnet.vnet_key][frontend_ip_configuration.value.subnet.key].id,
      ...
      public_ip_address_id = try(
        var.remote_objects.public_ip_addresses[frontend_ip_configuration.value.public_ip_address.lz_key][frontend_ip_configuration.value.public_ip_address.key].id,
        var.remote_objects.public_ip_addresses[var.client_config.landingzone_key][frontend_ip_configuration.value.public_ip_address.key].id,
