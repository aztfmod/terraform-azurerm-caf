...
resource "azurerm_application_gateway" "agw" {
  ...
  firewall_policy_id                = try(try(var.settings.firewall_policy_id, var.application_gateway_waf_policies[try(var.settings.waf_policy.lz_key, var.client_config.landingzone_key)][var.settings.waf_policy.key].id), null)
