...
resource "azurerm_kusto_cluster" "kusto" {
  ...
  dynamic "virtual_network_configuration" {
    ...
    content {
      subnet_id                    = try(virtual_network_configuration.value.vnet_key, null) == null ? null : try(var.combined_resources.vnets[try(virtual_network_configuration.value.lz_key, var.client_config.landingzone_key)][virtual_network_configuration.value.vnet_key].subnets[virtual_network_configuration.value.subnet_key].id, null)
