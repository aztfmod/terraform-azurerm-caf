    ...
    content {
      ...
      dynamic "ip_restriction" {
        ...
        content {
          ...
          virtual_network_subnet_id = can(ip_restriction.value.virtual_network_subnet_id) ? ip_restriction.value.virtual_network_subnet_id : var.combined_objects.networking[try(ip_restriction.value.lz_key, var.client_config.landingzone_key)][ip_restriction.value.vnet_key].subnets[ip_restriction.value.subnet_key].id
