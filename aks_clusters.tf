...
module "aks_clusters" {
  ...
  application_gateway = can(each.value.addon_profile.ingress_application_gateway) ? local.combined_objects_application_gateway_platforms[try(local.client_config.landingzone_key, each.value.addon_profile.ingress_application_gateway.lz_key)][each.value.addon_profile.ingress_application_gateway.key] : null
