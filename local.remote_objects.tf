locals {
  remote_objects = {
    ...
    api_management_product                         = try(local.combined_objects_api_management_product, null)
    api_management_group                           = try(local.combined_objects_api_management_group, null)
    api_management_user                            = try(local.combined_objects_api_management_user, null)
