locals {
  remote_objects = {
    ...
    azuread_service_principal_token_signing_certificates = try(local.azuread_service_principal_token_signing_certificates, null)
    ...
    monitor_dashboard_grafana                            = try(local.combined_objects_monitor_dashboard_grafana, null)
